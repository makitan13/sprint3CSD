...
import 'package:flutter_app/screens/books/bookloan_overdue.dart';
import 'package:flutter_app/screens/books/bookloan_outstanding.dart';
import 'package:flutter_app/services/auth_provider.dart';
import 'package:flutter_app/services/auth_service.dart';
import 'package:provider/provider.dart';

class BasePageLibrarian extends StatefulWidget {
  final String title;
  final Widget body;

  const BasePageLibrarian({
    Key? key,
    required this.title,
    required this.body,
  }) : super(key: key);
...
class _BasePageState extends State<BasePageLibrarian> {
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => BookloanOutstanding()),
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => BookloanOverdue()),
                      );
                    },
                  ),
                ],
