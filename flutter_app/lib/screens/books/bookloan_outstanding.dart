...
class BookloanOutstanding extends StatefulWidget {
  @override
  _OutstandingBookLoanPageState createState() =>
      _OutstandingBookLoanPageState();
}

class _OutstandingBookLoanPageState extends State<BookloanOutstanding> {
  ...
  Future<void> _fetchLoans() async {
    ...
    try {
      final response = await fetchOutstandBookLoans(_currentPage);
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Outstanding Book Loans'),
      ),
      body: Column(
        children: [
          _isLoading
