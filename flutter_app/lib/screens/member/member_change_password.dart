...
class MemberChangePassword extends StatefulWidget {
  @override
  _ChangePasswordPageState createState() => _ChangePasswordPageState();
}

class _ChangePasswordPageState extends State<MemberChangePassword> {
  ...
  Future<void> _changePassword() async {
    ...
    final response = await http.post(
      Uri.parse('http://127.0.0.1:8000/api/change_password/member/$username'),
